...
export default function RegisterPage() {
  ...
  // Pre-select trade role from URL query param (e.g. /register?role=buyer)
      ...
      <div className="bg-card border border-border rounded-lg p-5 relative">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-start">
            ...
            <div>
              <p className="text-xs uppercase tracking-wide text-muted-foreground mb-1 text-right">Trade Role</p>
